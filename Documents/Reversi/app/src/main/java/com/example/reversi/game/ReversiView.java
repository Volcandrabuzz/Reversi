...
import com.example.reversi.util.Util;
...
public class ReversiView extends SurfaceView implements Callback {
	...
	/**
	 * This View background width and height
	 */
	private float bgLength;

	/**
	 * This View chessboard width and height
	 */
	private float chessBoardLength;

	/**
	 * An array of the ratio of the background width to the screen width
	 */
	private float scale[] = new float[] { 0.75f, 0.80f, 0.85f, 0.90f, 0.95f };

	/**
	 * The index of the proportion of the background width to the screen width
	 */
